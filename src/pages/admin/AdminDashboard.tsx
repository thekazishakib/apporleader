...
import {
  Users, Image, Calendar, BookOpen, Shield,
...
export default function AdminDashboard() {
  ...
  const totalContent = members.length + leadershipTeam.length + gallery.length + events.length + blogs.length + videos.length;
  ...
  const quickActions = [
    ...
    { label: 'Manage Members', to: '/members', icon: Users, desc: 'Add or remove members' },
