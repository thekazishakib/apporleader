...
export default function Workshops() {
  ...
  return (
    <div className="w-full bg-[#0a0a0a] min-h-screen">
      <Helmet>
        <title>Workshops &amp; Events | ApporLeader – Kazi Shakib</title>
        <meta name="description" content="ApporLeader workshops, seminars, and competitions — founded by Kazi Shakib. Join 20+ events to learn AI, logic, chess, and business strategy. Led by Kazi Shakib for future leaders." />
        <meta name="keywords" content="ApporLeader, Kazi Shakib, workshops, events, AI workshop, chess competition, business strategy, seminar, Kazi Shakib ApporLeader, apporleader workshop, logic, future leaders" />
        <meta name="author" content="Kazi Shakib" />
        <link rel="canonical" href="https://apporleader.vercel.app/workshops" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="ApporLeader" />
        <meta property="og:title" content="Workshops &amp; Events | ApporLeader – Kazi Shakib" />
        <meta property="og:description" content="Join ApporLeader's 20+ workshops, seminars, and competitions. Founded by Kazi Shakib to train future leaders in AI, logic, chess, and strategy." />
        ...
        <meta name="twitter:site" content="@apporleader" />
        <meta name="twitter:title" content="Workshops &amp; Events | ApporLeader – Kazi Shakib" />
        <meta name="twitter:description" content="Join ApporLeader's 20+ workshops, seminars, and competitions. Founded by Kazi Shakib." />
