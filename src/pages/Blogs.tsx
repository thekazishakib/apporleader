  ...
  return (
    <div className="w-full bg-[#0a0a0a] min-h-screen">
      <Helmet>
        ...
        <meta name="description" content="Read insightful articles on logic, technology, AI, and business strategy from the ApporLeader community." />
        <link rel="canonical" href="https://apporleader.vercel.app/blogs" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="ApporLeader" />
        <meta property="og:title" content="Blogs | ApporLeader" />
        <meta property="og:description" content="Read insightful articles on logic, technology, AI, and business strategy from the ApporLeader community." />
        <meta property="og:url" content="https://apporleader.vercel.app/blogs" />
        <meta property="og:image" content="https://apporleader.vercel.app/og-image.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Blogs | ApporLeader" />
        <meta name="twitter:description" content="Read insightful articles on logic, technology, AI, and business strategy from the ApporLeader community." />
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-5">
                ...
                <div>
                  ...
                  <textarea required value={formData.content} onChange={e => setFormData({...formData, content: e.target.value})} className={`${inputCls} h-64 resize-y font-mono text-xs`} placeholder="Write in Markdown: **bold**, # Heading, - list item..." />
                </div>
              </div>
