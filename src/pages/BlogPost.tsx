    ...
    <div className="w-full bg-[#0a0a0a] min-h-screen pb-24">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-10">
        ...
        >
          ...
          <div className="prose prose-invert prose-lg max-w-none prose-headings:text-white prose-p:text-gray-300/95 prose-li:text-gray-300/95 prose-strong:text-white prose-a:text-primary hover:prose-a:text-primary/80 prose-img:rounded-xl leading-relaxed">
