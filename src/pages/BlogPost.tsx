...
import { formatBlogDateDisplay } from '../utils/formatBlogDate';
  ...
  return (
    <div className="w-full bg-[#0a0a0a] min-h-screen pb-24">
      <Helmet>
        ...
        <link rel="canonical" href={`https://apporleader.vercel.app/blogs/${blog.id}`} />
        <meta property="og:type" content="article" />
        <meta property="og:site_name" content="ApporLeader" />
        <meta property="og:title" content={`${blog.title} | ApporLeader`} />
        <meta property="og:description" content={blog.excerpt} />
        <meta property="og:url" content={`https://apporleader.vercel.app/blogs/${blog.id}`} />
        <meta property="og:image" content="https://apporleader.vercel.app/og-image.png" />
        <meta property="og:image:secure_url" content="https://apporleader.vercel.app/og-image.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:type" content="image/png" />
        <meta property="og:image:alt" content={`${blog.title} — ApporLeader`} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@apporleader" />
        <meta name="twitter:title" content={`${blog.title} | ApporLeader`} />
        <meta name="twitter:description" content={blog.excerpt} />
        <meta name="twitter:image" content="https://apporleader.vercel.app/og-image.png" />
        <meta name="twitter:image:alt" content={`${blog.title} — ApporLeader`} />
      </Helmet>
