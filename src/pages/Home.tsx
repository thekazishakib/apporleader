        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 flex gap-2">
          {images.map((_, i) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition-all duration-300 ${i === current ? 'bg-primary w-5' : 'bg-white/30'}`}
            />
          ))}
        </div>
      )}
...
export default function Home() {
  const { events, membershipUrl, siteSettings } = useAdmin();
  const regUrl = siteSettings.registrationUrl.trim();
  const showSeparateRegistration = regUrl !== '' && regUrl !== membershipUrl.trim();
  const upcomingPreview = useMemo(
    () => sortEventsForDisplay(events).filter((e) => isUpcomingEvent(e.date)).slice(0, 3),
    [events]
  );
  ...
  return (
    <div className="w-full">
      <Helmet>
        ...
        <meta name="description" content="ApporLeader is a free community for logic, AI, and business strategy. Join us for workshops, competitions, and global networking to decode logic and master AI." />
        <meta name="keywords" content="ApporLeader, AI, Artificial Intelligence, Logic, Business Strategy, Workshops, Competitions, Networking, Learning, Community, Chess" />
        <link rel="canonical" href="https://apporleader.vercel.app/" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="ApporLeader" />
        <meta property="og:title" content="ApporLeader | Decoding Logic, Mastering AI, Winning the Game" />
        <meta property="og:description" content="ApporLeader is a free community for logic, AI, and business strategy. Join workshops, competitions, and global networking." />
        <meta property="og:url" content="https://apporleader.vercel.app/" />
        <meta property="og:image" content="https://apporleader.vercel.app/favicon.svg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="ApporLeader | Decoding Logic, Mastering AI, Winning the Game" />
        <meta name="twitter:description" content="ApporLeader is a free community for logic, AI, and business strategy. Join workshops, competitions, and global networking." />
      ...
      <section className="relative min-h-[95vh] flex items-center justify-center overflow-hidden pt-16 pb-20 sm:pt-24 sm:pb-32">
        {/* Background: slideshow when images available, else animated blobs */}
        {heroImages.length > 0 ? (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
          ...
          <motion.div 
            ...
            className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-6 justify-center items-center w-full max-w-3xl mx-auto"
          >
            <a 
              href={membershipUrl}
              target="_blank"
            ...
            {showSeparateRegistration && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center px-6 py-3 sm:px-8 sm:py-4 font-bold text-white border border-primary/50 bg-primary/10 rounded-full transition-all hover:bg-primary/20 w-full sm:w-auto"
              >
                Registration Form
              </a>
            )}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div>
              ...
              <p className="text-gray-400 text-lg max-w-2xl">Join our live sessions, workshops, and tournaments.</p>
            </div>
            <Link to="/workshops" className="inline-flex items-center text-primary hover:text-white transition-colors font-medium">
      ...
      <section className="py-24 bg-[#0a0a0a] border-t border-white/5 relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg">Everything you need to know about ApporLeader.</p>
          </div>
