...
export default function About() {
  ...
  const handleDelete = (id: string) => {
    ...
    if (window.confirm('Are you sure you want to delete this leader?')) {
      if (member?.image) void deleteImageFromStorage(member.image);
  ...
  return (
    <div className="w-full bg-[#0a0a0a]">
      <Helmet>
        ...
        <meta name="description" content="Learn about ApporLeader, our mission, vision, and the leadership team driving our community forward in AI, logic, and business strategy." />
        <link rel="canonical" href="https://apporleader.vercel.app/about" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="ApporLeader" />
        <meta property="og:title" content="About Us | ApporLeader" />
        <meta property="og:description" content="Learn about ApporLeader, our mission, vision, and the leadership team driving our community." />
        <meta property="og:url" content="https://apporleader.vercel.app/about" />
        <meta property="og:image" content="https://apporleader.vercel.app/favicon.svg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="About Us | ApporLeader" />
        <meta name="twitter:description" content="Learn about ApporLeader, our mission, vision, and the leadership team driving our community." />
