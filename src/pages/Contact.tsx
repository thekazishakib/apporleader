              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">apporleader@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="https://chat.whatsapp.com/JdlG8D7neCtLwxXRXmoETc" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-secondary transition-colors">Message us on WhatsApp</a>
                  </div>
                </div>
              </div>
