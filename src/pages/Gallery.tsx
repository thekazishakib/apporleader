...
import { X, Maximize2, Plus, Edit2, Trash2, Youtube, Play, ChevronLeft, ChevronRight, Pin } from 'lucide-react';
...
export default function Gallery() {
  const { isAdmin, gallery, setGallery, videos, setVideos, siteSettings } = useAdmin();
                ...
                <div className="space-y-5">
                  ...
                  {videoForm.url && getYouTubeId(videoForm.url) && (
                    <div className="rounded-xl overflow-hidden border border-white/10 aspect-video">
                      <img src={`https://img.youtube.com/vi/${getYouTubeId(videoForm.url)}/hqdefault.jpg`} alt="Preview" className="w-full h-full object-cover" />
                    </div>
                  )}
                </div>
                <div className="flex gap-4 mt-8">
