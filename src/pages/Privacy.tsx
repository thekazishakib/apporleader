...
export default function Privacy() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] pt-24 pb-16">
      <Helmet>
        <title>Privacy Policy | ApporLeader</title>
        <meta name="description" content="Read the Privacy Policy for ApporLeader. Learn how we collect, use, and protect your personal information." />
        <link rel="canonical" href="https://apporleader.vercel.app/privacy" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Privacy Policy | ApporLeader" />
        <meta property="og:url" content="https://apporleader.vercel.app/privacy" />
